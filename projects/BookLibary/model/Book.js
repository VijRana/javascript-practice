...
// Convert row to object
 ...
 Book.loadAll= function(){
     var key="", keys=[], bookString="", books={},i=0;
     try{
     ...
     if(bookString){
        ...
        console.log(keys.length + "book loaded!");
 ...
 //save all book object to Local Storage
 ...
 Book.saveAll= function(){
    ...
    if(!error){
       console.log(numOfBooks + "books saved.");
  }
 };
